...
1. Select **Teams**, click **Join or create a team** and click **Create Team**.
...
1. Enter **Green** for Team name and click **Create**.

    ![A screenshot with the word green in the team name field](03-1/media/ex1-t1-image2.png)

1. Click **Skip**.

1. You should now have a new team named **Green**.
...
1.  Right click on the Power Apps tab and select  **Pin**.
...
1. Select Power Apps and click **Start now**.
...
1. Wait till things getting ready for you.

1. Enter **Upcycle** for App name and click **Save**.
...
1. Enter **Description** for Name select **Text** for Type, and click to expand the **Advanced options** section.

    ![A Screenshot with an arrow pointing to the advanced options button](03-1/media/ex2-t2-image3.png)

1. Change the **Max length** to **500** and click **Create**.

1. Click **+ Add column** again.

1. Enter **Availability** for Name, select **Choice** for Type, enter **Available** for the first choice and click **+ New choice**.

    ![A Screenshot with an arrow pointing to the new choice button](03-1/media/ex2-t2-image4.png)

1.  Enter **Reserved** for the second choice and click **+ New choice**.

1.  Enter **Picked up** for the third choice and click **Create**.

1.  Your table screen should now look like the image below.
...
1.  Close the table editor by clicking on the **Close** button.
...
1. Click  **+ Add column** column.

1. Enter **Location** for Display name, select **Text** for Data type, make the column **Required** and click **Done**.

    ![A screenshot of the add column window with the relevant text in each field](03-1/media/ex2-t3-image.png)

1. Click **+ Add column**.

1. Enter **Photo** for Display name, select **Image** for Data type, check the **Primary image** checkbox and click **Done**.

    ![A screenshot of the add column window with the relevant text in each field](03-1/media/ex2-t3-image3.png)

1.  Click **+ Add column**.

1.  Enter **Reserved by** for Display name, select **Lookup** for Data type, select **User** for Related table and click **Done**.

    ![A screenshot of the add column window with the relevant text in each field](03-1/media/ex2-t3-image4.png)

1.  Select the **Availability** column.

1. Select **Available** for Default value and click **Done**

    ![A screenshot with a box around available selected as the default value option](03-1/media/ex2-t3-image5.png)

1. Click the **Save table** button located on the bottom right of the screen.
...
1. Select **Screen1**. If the screen already contains the form, move to the next step, otherwise click **With data** and select **Gadgets** table under **Current environment**. That will create the screen elements including the form.

1. Make sure **RightContainer1** is expanded and select the **EditForm1** control from tree view.
...
1. Select the fields that does not exist on the EditForm control from the below list and click **Add**.
...
1. Change **Columns** for Snap to columns to **1**.
...
1. Select **Items** form the formula bar and replace the value with formula below. This formula will filter the gadgets to show only the available gadgets
...
1.  Your app should now look like the image below. Close the preview.
...
1. Set the **Text** value of the Button to **Reserve**.

1. Move the Reserve Button and place it next to the Image.
...
1. Click on the **+** Insert button and select **Button** again.

1. Select the **Tree view**, double click on the button you just added and rename it **Picked Up Button**.
...
1. Adjust the width and move the Picked Up Button and place it to the right of the Reserve Button.
...
1. Click on the **+** Insert menu and select **+ Add icon**.

1. Place the icon above the form.
...
1. Select the text box you just added and rename it **Search box**.
...
1.  Go to the formula bar and remove the **Value** text.
...
1. Search for cable. The gallery should show items that have the text **cable** in the name or description column.
...
1. Select **Teams** and select the new **Upcycle** tab.
